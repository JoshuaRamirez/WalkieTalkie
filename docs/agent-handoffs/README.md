...
| [2026-07-phase-6-close.md](./2026-07-phase-6-close.md) | **(most recent)** Phase 6 "The Network" complete: real mutual TLS 1.3 (SVID peer auth), SWIM gossip membership + failure detection, gossip discovery gated by admission, multi-hop deny-by-default routing, pooled connections — culminating in a 3-node A→relay→C signed round trip over mTLS. 48 proof obligations. Loopback ≠ fake; Phase 7 = real WAN/NAT, PKI custody, kernel sandbox, mesh scale. |
