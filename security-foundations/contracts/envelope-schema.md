...
- `resource` is an optional non-empty string. When a capability token
  ...
  resource. Adding this field is a backwards-compatible optional
  addition (`additionalProperties` stays `false`).
