...
class DenyReason(StrEnum):
    ...
    # --- Session tokens (Phase 2 Track E E2) ---
    SESSION_MALFORMED = "session_malformed"
    SESSION_EXPIRED = "session_expired"
    SESSION_NOT_YET_VALID = "session_not_yet_valid"
    SESSION_INVALID_VALIDITY_WINDOW = "session_invalid_validity_window"
    SESSION_TTL_EXCEEDED = "session_ttl_exceeded"
    SESSION_SIGNATURE_INVALID = "session_signature_invalid"
    SESSION_UNKNOWN_ISSUER = "session_unknown_issuer"
    SESSION_RESUME_SEQUENCE_INVALID = "session_resume_sequence_invalid"
    SESSION_RESUME_PARENT_MISMATCH = "session_resume_parent_mismatch"
    SESSION_RESUME_SESSION_MISMATCH = "session_resume_session_mismatch"
    SESSION_RESUME_SCOPE_DRIFT = "session_resume_scope_drift"
    ...
    SYBIL_ATTESTATION_PROOF_MALFORMED = "sybil_attestation_proof_malformed"
    SYBIL_ATTESTATION_BURDEN_INSUFFICIENT = "sybil_attestation_burden_insufficient"
